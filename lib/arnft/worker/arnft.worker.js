...
if (browser === "Apple Safari") {
  importScripts(new URL(new URL("./ARToolkitNFT.js", import.meta.url), self.location.origin));
  // importScripts("ARToolkitNFT.js");
} else {
  importScripts(new URL(new URL("./ARToolkitNFT_simd.js", import.meta.url), self.location.origin));
  // importScripts("ARToolkitNFT_simd.js");
}
var arController = null;
var currentMarkerResult = null;
var nextImageData = null;
...
function _load() {
  _load = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(msg) {
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.prev = 2;
          _context.next = 5;
          return ARControllerNFT.initWithDimensions(msg.pw, msg.ph, msg.cameraParamUrl);
        case 5:
          arController = _context.sent;
...
function loadMarkers(markers) {
  arController.loadNFTMarkers(markers, function (ids) {
    var markers = ids.map(function (id, index) {
...
function process() {
  ...
  if (currentMarkerResult) {
    var matrix = currentMarkerResult.matrixGL_RH;
