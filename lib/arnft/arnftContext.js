...
var cameraParamUrl = new URL(new URL("/data/camera_para.dat", import.meta.url), self.location.origin);
                  ...
                  return _regeneratorRuntime().wrap(function _callee$(_context) {
                    while (1) switch (_context.prev = _context.next) {
                      case 0:
                        ...
                        arnft = new ARNft(cameraParamUrl, video.current, gl, camera, onLoaded, interpolationFactor);
...
var useNftMarker = function useNftMarker(url) {
  var ref = useRef();
  var _useARNft = useARNft(),
    markersRef = _useARNft.markersRef;
  useEffect(function () {
    var newMarkers = [].concat(_toConsumableArray(markersRef.current), [{
      url: url,
      root: ref.current
    }]);
