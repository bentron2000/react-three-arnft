...
var cameraParamUrl = "/camera_para.dat";
                  ...
                  return _regeneratorRuntime().wrap(function _callee$(_context) {
                    while (1) switch (_context.prev = _context.next) {
                      case 0:
                        ...
                        arnft = new ARNft(new URL(cameraParamUrl, self.location.origin).toString(), video.current, gl, camera, onLoaded, interpolationFactor);
